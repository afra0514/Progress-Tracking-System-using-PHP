...
<head>
    ...
    <title>View Skills | Progress Pal</title>
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom shadow-sm">
    ...
    <div class="container">
        <h2 class="mt-5">Tracked Skills</h2>
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4" class="text-center">No skills tracked yet.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
        <a href="track_skills.php" class="btn btn-primary">Add More Skills</a>
