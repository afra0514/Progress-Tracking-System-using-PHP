...
<head>
    ...
    <title>Track Projects | Progress Pal</title>
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom shadow-sm">
    ...
    <div class="container">
        ...
        <h2 class="mt-5">Track Projects</h2>
        <form action="track_projects_save.php" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control" id="projectLink" name="project_link" placeholder="Enter project URL">
            </div>
           ...
           <div class="row">
                ...
                <div class="col-6">
                    <a href="view_projects.php" class="btn btn-info w-100">Project List</a>
                </div>
            </div>
        </form>
