        ...
        <tbody>
            <?php while ($user = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td>
                        <a href="action_user.php?edit=<?php echo $user['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="action_user.php?delete=<?php echo $user['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
